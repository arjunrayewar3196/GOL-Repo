...
//}
  ...
  stage('Sonarqube') {
    ...
    stage('Deploy War') {
      steps {
          print("Deployment")
          //deploy adapters: [tomcat8(credentialsId: 'tomcat-cred', path: '', url: 'http://65.0.95.234:8080/')], contextPath: null, war: '**/*.war'
...
post {
        ...
        failure {
            mail to:"arjunrayewar3196@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
